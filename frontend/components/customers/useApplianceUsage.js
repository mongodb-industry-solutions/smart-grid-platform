...
/**
 * Fetches average appliance power breakdown for a customer.
 ...
 */
export function useApplianceUsage(dataid) {
  ...
  useEffect(() => {
    ...
    const fetchUsage = async () => {
      try {
        const res = await fetch(`${CUSTOMERS_ENDPOINT}/${dataid}/appliances`);
