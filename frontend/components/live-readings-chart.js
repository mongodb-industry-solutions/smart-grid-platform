...
const LINES = [
  { key: "avg_reading", label: "Avg Reading", color: "#00684A" },
];
      ...
      try {
        ...
        if (data.length) {
          ...
          const point = {
            ...
            avg_reading: parseFloat(avg("avg_reading").toFixed(2)),
          };
        ...
        {!history.length ? (
          ...
          <ResponsiveContainer width="100%" height={320}>
            ...
            >
              ...
              <XAxis
                dataKey="time"
                tick={{ fontSize: 11, fill: "#5C6970" }}
                tickLine={false}
                axisLine={{ stroke: "#c1c7c6" }}
              ...
              <Tooltip
                contentStyle={{
                  ...
                  borderRadius: "6px",
                  fontSize: "12px",
                  boxShadow: "0 2px 8px rgba(0,30,43,0.10)",
                }}
                labelStyle={{ color: "#001E2B", fontWeight: 600, marginBottom: 4 }}
                cursor={{ stroke: "#c1c7c6", strokeWidth: 1 }}
              />
              <Legend
                iconType="circle"
                iconSize={8}
